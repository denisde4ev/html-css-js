...
// @version      1.1
// @author       denisde4ev
// @description  fix: sometimes (Ctrl+C / Right Click + Copy) triggers event
// @description  that selects less text before the copy text happens
// @description  
// @description  2025-07-04T06:31:51+03:00
// @namespace    Violentmonkey Scripts
// @run-at       document-start
// @homepage     https://github.com/denisde4ev/html-css-js/blob/master/js/user-scripts/copilot/fix-copy.user.js
// @license      GPTv3
// @namespace    Violentmonkey Scripts
// @grant        none
// ==/UserScript==
...
// console.log('hi, from userscript name: Copilot fix sometimes refuses to copy');
...
EventTarget.prototype.removeEventListener = function(type, listener, options) {
	...
	if (0) if (wrapped) {
		console.log(
			'rm wrapped event called',
			{ this: this, wrapped, listener },
			new Error('not error. just stack trace'),
		);
	}
